...
<template>
  <div class="modalBack">
    <div class="modal flex flex-col rounded-lg p-3 bg-gray-300 gap-y-4 overflow-auto">
      <div class="flex justify-between">
       <p>sdfjkdsf</p>
      </div>
      <div class="mt-2 flex flex-col gap-y-3 ">
        <p class="flex gap-x-4 items-center flex-end text-gray-600 font-medium text-sm">
          <span><svg width="20px" height="20px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink">

              <g id="🔍-System-Icons" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="ic_fluent_text_description_24_regular" fill="#212121" fill-rule="nonzero">
                  <path
